                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="3u 12u$(large)">
                                        <a href="sensor.php" class="btn btn-danger" style="text-decoration: none;">Sensor-details</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="weather.html" class="btn btn-danger" style="text-decoration: none;">Weather details</a>
                                    </div>
                                    <div class="3u 12u$(large)">
