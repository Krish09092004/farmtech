...
<body>
    ...
    <div class="box">
        <form action="changePassword.php" method="post">
            ...
            <br>
            <input type="phonenumber"  class="inp" name="mobile" placeholder="Phone Number" required><br>
...
if (isset($_POST['register'])) {
    $phonenumber = mysqli_real_escape_string($con, $_POST['mobile']);
    $password = mysqli_real_escape_string($con, $_POST['password']);
    $confirmpassword = mysqli_real_escape_string($con, $_POST['pass']);

    $query = "select * from farmer where fmobile = '$mobile'";
