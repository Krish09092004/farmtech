...
<html lang="en">
    ...
    <body class="subpage">
        ...
        <section id="post" class="wrapper bg-img" data-bg="images/pic05.jpg">
            <div class="inner">
                <div class="box">
                <header>
                ...
                <form method="post" action="updateProfile.php">
                    <div class="row uniform">
                        ...
                        <div class="4u 12u$(xsmall)">
                            <input type="number" name="mobile" id="mobile" value="<?php echo $_SESSION['MobileNo'];?>" placeholder="Mobile No" required/>
                        </div>
